...
class WinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wine" do
    assert_difference('Wine.count') do
      post wines_url, params: { wine: { appellation_id: @wine.appellation_id, wine_type: @wine.wine_type } }
    end
  ...
  test "should update wine" do
    patch wine_url(@wine), params: { wine: { appellation_id: @wine.appellation_id, wine_type: @wine.wine_type } }
